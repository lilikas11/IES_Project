            ...
            <div className="profile-details">
                {isEditing ? (
                    <div>
                        ...
                        <label>
                            <p>Nome:</p> <input type="text" placeholder='Set a Profile Name' value={name} onChange={(e) => setName(e.target.value)} />
                        </label>
                        <label>
                            <p>Email:</p> <input type="text" placeholder='Your Email' value={email} onChange={(e) => setEmail(e.target.value)} />
                        </label>
                        <label>
                            <p>Telefone:</p> <input type="text" placeholder='Optional' value={phone} onChange={(e) => setPhone(e.target.value)} />
                        </label>
                        <label>
